...
| 日付 | バージョン | 変更内容 |
|------|------------|----------|
| 2025-10-09 | v2.5 | 利用目的を1項目入力に簡素化。第三者提供の文言を「行う場合がある」方向へ修正。実在企業例を追加。発効日入力欄を1/4幅に縮小。アクセス解析プレースホルダーをGoogle Analytics実例に変更。 |
| 2025-10-08 | v2.4 | 初期状態で「該当なし」をデフォルトチェック。標準文言自動挿入機能を実装。最小入力モードを強化。 |
